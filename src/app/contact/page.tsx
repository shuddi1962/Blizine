  ...
  return (
    <div className="w-full">
      ...
      <div className="relative overflow-hidden mb-12 min-h-[320px] flex items-center">
        <Image src="https://images.pexels.com/photos/7597401/pexels-photo-7597401.jpeg" alt="Customer service agent" fill className="object-cover" sizes="100vw" priority />
