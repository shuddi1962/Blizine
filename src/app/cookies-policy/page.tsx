...
export default function CookiesPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      {/* Hero Banner */}
      <div className="relative rounded-2xl overflow-hidden mb-12 bg-gradient-to-br from-orange-600/20 via-amber-500/10 to-yellow-600/20 border border-orange-500/20">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(251,146,60,0.12),transparent_50%),radial-gradient(ellipse_at_bottom_right,rgba(234,179,8,0.08),transparent_50%)]" />
